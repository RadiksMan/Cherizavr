			        	...
			        	<div class="col-xs-12 text-right">
							<div class="header-top">
								<div class="select-leng">
									<div class="lang-wrap active"><a href="#">RU</a></div>|
									<div class="lang-wrap"><a href="#">EN</a></div>
								</div>
								<div class="social-b">
						...
						<div class="col-sm-2 col-xs-6 pull-right">
							<div class="header-right clear ">
								<div class="user-image">
									<a href="#"><img src="images/user-avatar.png"  alt=""></a>
								</div>
								<div class="user-text-wrap">
									<div class="user-text">
										<p><a href="#">User123</a></p>
										<p><a href="#">Выйти</a></p>
									</div>
								</div>
							</div>
							...
							<div class="header-logo">
								<a href="#">
									<div class="header-logo-1">
										<img src="images/logo-exitmania-eng.png"  alt="">
									</div>
									<div class="header-logo-2">
										<img src="images/logo-kachka.png" alt="">
									</div>
									<div class="header-logo-3">
										<img src="images/logo-exitmania-rus.png" alt="">
									</div>
								</a>
							</div>
						</div>
